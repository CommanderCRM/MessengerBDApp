...
{
    public partial class FormUsersForCA : Form
    {
        public FormUsersForCA()
        {
            InitializeComponent();
        }
        ...
        private static FormUsersForCA f;
        public static FormUsersForCA fusrca
        {
            get
            {
                if (f == null || f.IsDisposed) f = new FormUsersForCA();
                return f;
            }
        }
